        ...
        <>
            ...
            <div className="py-6 flex justify-center">
                <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                    ...
                    <img src="https://tailwindcss.com/_next/static/media/beach-house.9b9ee168.jpg" alt="" className="hover:shadow-xl hover:shadow-gray-500 hover:scale-150 transition-all cursor-pointer w-full h-60 object-cover rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full" loading="lazy"/>
                    <img src="https://tailwindcss.com/_next/static/media/beach-house-interior-1.f151eb56.jpg" alt="" className="hover:shadow-xl hover:shadow-gray-500 lg:hover:scale-150 transition-all cursor-pointer hidden w-full h-52 object-cover rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy"/>
                    <img src="https://tailwindcss.com/_next/static/media/beach-house-interior-2.3672af98.jpg" alt="" className="hover:shadow-xl hover:shadow-gray-500 lg:hover:scale-150 transition-all cursor-pointer hidden w-full h-52 object-cover rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy"/>
                    </div>
